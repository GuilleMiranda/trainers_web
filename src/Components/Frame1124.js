	...
	return (
		<div className='Frame1124_Frame1124'>
			...
			<div className='ChatBar'>
				...
				<div className='Send'>
					<img className='Vector' src = {ImgAsset.Frame1124_Vector} />
					<img className='Vector_1' src = {ImgAsset.Frame1124_Vector_1} />
				</div>
				<div className='Attachfile'>
					<img className='Vector_2' src = {ImgAsset.Frame1124_Vector_2} />
					<img className='Vector_3' src = {ImgAsset.Frame1124_Vector_3} />
				</div>
			...
			<div className='Group33'>
				...
				<div className='ContactList'>
					<div className='Contact'>
						...
						<div className='__1'>
							<img className='Vector_4' src = {ImgAsset.Frame1124_Vector_4} />
							<img className='Vector_5' src = {ImgAsset.Frame1124_Vector_5} />
						</div>
					</div>
					<div className='Contact_1'>
						...
						<div className='__2'>
							<img className='Vector_6' src = {ImgAsset.Frame1124_Vector_6} />
							<img className='Vector_7' src = {ImgAsset.Frame1124_Vector_7} />
						</div>
					</div>
					<div className='Contact_2'>
						...
						<div className='__3'>
							<img className='Vector_8' src = {ImgAsset.Frame1124_Vector_8} />
							<img className='Vector_9' src = {ImgAsset.Frame1124_Vector_9} />
						</div>
					</div>
				</div>
				...
				<div className='Group29'>
					...
					<div className='Frame4'>
						<div className='search'>
							<img className='Vector_10' src = {ImgAsset.Frame1124_Vector_10} />
							<img className='Vector_11' src = {ImgAsset.Frame1124_Vector_11} />
						</div>
						<span className='Search'>Search</span>
					</div>
				</div>
				<img className='Vector2' src = {ImgAsset.Frame1124_Vector2} />
				<div className='Banner'>
					...
					<div className='Accountcircle'>
						...
						<img className='Vector_12' src = {ImgAsset.Frame1124_Vector_12} />
						<img className='Vector_13' src = {ImgAsset.Frame1124_Vector_13} />
					</div>
					<span className='CinthiaRojas_1'>Cinthia Rojas</span>
				</div>
				<div className='Logo'>
					<img className='image1' src = {ImgAsset.Frame1124_image1} />
				</div>
			</div>
			<img className='Line1' src = {ImgAsset.Frame1124_Line1} />
			...
			<Link to='/frame357'>
				<div className='Close'>
					<img className='Vector_14' src = {ImgAsset.Frame1124_Vector_14} />
					<img className='Vector_15' src = {ImgAsset.Frame1124_Vector_15} />
				</div>
			</Link>
		</div>
	)
